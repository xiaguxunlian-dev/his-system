 ...
 * 适用岗位: 门诊医生、住院医生、管理员
 */
public class EmrApp extends Application {
    private static final Logger log = LoggerFactory.getLogger(EmrApp.class);
    private static final String MODULE_NAME = "电子病历系统";
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            LoginDialog.requireLogin(MODULE_NAME, UserRole.门诊医生, UserRole.住院医生);
            String userInfo = UserSession.getInstance().getDisplayInfo();

            EmrView view = new EmrView();
