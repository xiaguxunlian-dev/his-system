 ...
 * 适用岗位: 住院医生、管理员
 */
public class InpatientApp extends Application {
    private static final Logger log = LoggerFactory.getLogger(InpatientApp.class);
    private static final String MODULE_NAME = "住院管理子系统";
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            LoginDialog.requireLogin(MODULE_NAME, UserRole.住院医生);
            String userInfo = UserSession.getInstance().getDisplayInfo();

            InpatientView view = new InpatientView();
