...
public class PharmacyApp extends Application {
    private static final Logger log = LoggerFactory.getLogger(PharmacyApp.class);
    private static final String MODULE_NAME = "药品管理子系统";
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            LoginDialog.requireLogin(MODULE_NAME, UserRole.药剂师);
